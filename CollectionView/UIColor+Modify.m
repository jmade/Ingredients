...
- (UIColor *)lightenColor:(CGFloat)lighten{
    CGFloat hue = 0, saturation = 0, brightness = 0.75, alpha = 0;
    [self getHue:&hue saturation:&saturation brightness:&brightness alpha:&alpha];
    return [UIColor colorWithHue:hue saturation:saturation*(1-lighten) brightness:brightness*(2.5+lighten) alpha:alpha];
}
